Gem::Specification.new do |s|
  ...
  s.files = ["Manifest", "README", "MIT-LICENSE", "Rakefile", "viddlerruby.gemspec", "lib/core_extensions.rb", "lib/parser.rb", "lib/session.rb", "lib/viddler.rb", "lib/video.rb", "test/core_extensions_test", "test/parser_test", "test/session_test", "test/test_helper", "test/video_test", "test/video_test.rb", "test/remote/session_test.rb", "test/remote/test.mov", "test/remote/video_test.rb","test/remote/video_upload_test.rb"]
  s.test_files = ["test/core_extensions_test", "test/parser_test", "test/session_test", "test/test_helper", "test/video_test", "test/remote/session_test.rb", "test/remote/test.mov", "test/remote/video_test.rb","test/remote/video_upload_test.rb"]
