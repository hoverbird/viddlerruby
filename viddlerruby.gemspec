Gem::Specification.new do |s|
  ...
  s.files = ["History", "Manifest", "README", "MIT-LICENSE", "Rakefile", "viddlerruby.gemspec", "lib/core_extensions.rb", "lib/parser.rb", "lib/session.rb", "lib/viddler.rb", "lib/video.rb", "test/core_extensions_test", "test/parser_test", "test/session_test", "test/test_helper", "test/video_test"]
